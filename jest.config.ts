...
const config: InitialOptionsTsJest = {
  ...
  setupFilesAfterEnv: ['jest-extended/all'], // A list of paths to modules that run some code to configure or set up the testing framework before each test
  moduleNameMapper: {
    // A map from regular expressions to module names or to arrays of module names that allow to stub out resources with a single module
    '^@core/(.*)': '<rootDir>/src/core/$1',
    '^@app/(.*)': '<rootDir>/src/three.js/$1',
